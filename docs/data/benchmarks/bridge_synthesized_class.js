...
class spec_class {
     ...
     */
    execEdge149() {
        var guard = (((spec.barriers_barrier1_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier1_f_sc_())) || ((spec.function_requirements_Barriers_Functional_barrier1_command_close_()) && (!(spec.function_requirements_Barriers_Functional_barrier1_barrier_S_closed_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier1_f_sc_())) && (spec.barriers_entering_closed_()));
     ...
     */
    execEdge150() {
        var guard = (((spec.barriers_barrier1_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier1_f_sc_())) || (((((spec.function_requirements_Barriers_Functional_barrier1_command_open_()) || (spec.bridgedeck_command_close_())) && (!(spec.function_requirements_Barriers_Functional_barrier1_command_close_()))) && (!(spec.function_requirements_Barriers_Functional_barrier1_command_stop_()))) && (!(spec.function_requirements_Barriers_Functional_barrier1_barrier_S_open_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier1_f_sc_())) && (spec.bridgedeck_bridgedeck_closed_()));
     ...
     */
    execEdge151() {
        var guard = (((spec.barriers_barrier1_A_) == (spec.specEnum._opening)) || ((spec.barriers_barrier1_A_) == (spec.specEnum._closing))) && (!(!(spec.function_requirements_Barriers_Functional_barrier1_f_sc_())) || (((spec.function_requirements_Barriers_Functional_barrier1_command_stop_()) || ((spec.function_requirements_Barriers_Functional_barrier1_barrier_S_closed_()) && (spec.function_requirements_Barriers_Functional_barrier1_barrier_A_closing_()))) || ((spec.function_requirements_Barriers_Functional_barrier1_barrier_S_open_()) && (spec.function_requirements_Barriers_Functional_barrier1_barrier_A_opening_()))));
     ...
     */
    execEdge152() {
        var guard = ((((spec.barriers_barrier2_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier2_f_sc_())) || ((spec.function_requirements_Barriers_Functional_barrier2_command_close_()) && (!(spec.function_requirements_Barriers_Functional_barrier2_barrier_S_closed_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier2_f_sc_())) && ((!(!(spec.safety_reqirements_Requirement2_Fault1_())) || (spec.LTS_stopsigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault2_())) || (spec.LTS_stopsigns_K_on_()))))) && ((((!(!(spec.safety_reqirements_Requirement2_Fault3_())) || (spec.LTS_stopsigns_SC_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault4_())) || (spec.LTS_stopsigns_SK_on_()))) && (!(spec.safety_reqirements_Requirement2_Fault1_()) || (spec.LTS_stopsigns_C_onF_()))) && (((!(spec.safety_reqirements_Requirement2_Fault2_()) || (spec.LTS_stopsigns_K_onF_())) && (!(spec.safety_reqirements_Requirement2_Fault3_()) || (spec.LTS_stopsigns_SC_onF_()))) && (!(spec.safety_reqirements_Requirement2_Fault4_()) || (spec.LTS_stopsigns_SK_onF_()))));
     ...
     */
    execEdge153() {
        var guard = ((((spec.barriers_barrier2_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier2_f_sc_())) || (((((spec.function_requirements_Barriers_Functional_barrier2_command_open_()) || (spec.bridgedeck_command_close_())) && (!(spec.function_requirements_Barriers_Functional_barrier2_command_close_()))) && (!(spec.function_requirements_Barriers_Functional_barrier2_command_stop_()))) && (!(spec.function_requirements_Barriers_Functional_barrier2_barrier_S_open_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier2_f_sc_())) && (spec.bridgedeck_bridgedeck_closed_()))) && (((!(!(spec.safety_reqirements_Requirement8_Fault1_())) || (spec.barriers_barrier1_open_())) && (!(!(spec.safety_reqirements_Requirement8_Fault2_())) || (spec.barriers_barrier4_open_()))) && (!(spec.safety_reqirements_Requirement8_Fault1_())));
     ...
     */
    execEdge154() {
        var guard = (((spec.barriers_barrier2_A_) == (spec.specEnum._opening)) || ((spec.barriers_barrier2_A_) == (spec.specEnum._closing))) && (!(!(spec.function_requirements_Barriers_Functional_barrier2_f_sc_())) || (((spec.function_requirements_Barriers_Functional_barrier2_command_stop_()) || ((spec.function_requirements_Barriers_Functional_barrier2_barrier_S_closed_()) && (spec.function_requirements_Barriers_Functional_barrier2_barrier_A_closing_()))) || ((spec.function_requirements_Barriers_Functional_barrier2_barrier_S_open_()) && (spec.function_requirements_Barriers_Functional_barrier2_barrier_A_opening_()))));
     ...
     */
    execEdge155() {
        var guard = ((((spec.barriers_barrier3_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier3_f_sc_())) || ((spec.function_requirements_Barriers_Functional_barrier3_command_close_()) && (!(spec.function_requirements_Barriers_Functional_barrier3_barrier_S_closed_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier3_f_sc_())) && ((!(!(spec.safety_reqirements_Requirement2_Fault1_())) || (spec.LTS_stopsigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault2_())) || (spec.LTS_stopsigns_K_on_()))))) && ((((!(!(spec.safety_reqirements_Requirement2_Fault3_())) || (spec.LTS_stopsigns_SC_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault4_())) || (spec.LTS_stopsigns_SK_on_()))) && (!(spec.safety_reqirements_Requirement2_Fault1_()) || (spec.LTS_stopsigns_C_onF_()))) && (((!(spec.safety_reqirements_Requirement2_Fault2_()) || (spec.LTS_stopsigns_K_onF_())) && (!(spec.safety_reqirements_Requirement2_Fault3_()) || (spec.LTS_stopsigns_SC_onF_()))) && (!(spec.safety_reqirements_Requirement2_Fault4_()) || (spec.LTS_stopsigns_SK_onF_()))));
     ...
     */
    execEdge156() {
        var guard = ((((spec.barriers_barrier3_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier3_f_sc_())) || (((((spec.function_requirements_Barriers_Functional_barrier3_command_open_()) || (spec.bridgedeck_command_close_())) && (!(spec.function_requirements_Barriers_Functional_barrier3_command_close_()))) && (!(spec.function_requirements_Barriers_Functional_barrier3_command_stop_()))) && (!(spec.function_requirements_Barriers_Functional_barrier3_barrier_S_open_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier3_f_sc_())) && (spec.bridgedeck_bridgedeck_closed_()))) && (((!(!(spec.safety_reqirements_Requirement8_Fault1_())) || (spec.barriers_barrier1_open_())) && (!(!(spec.safety_reqirements_Requirement8_Fault2_())) || (spec.barriers_barrier4_open_()))) && (!(spec.safety_reqirements_Requirement8_Fault2_())));
     ...
     */
    execEdge157() {
        var guard = (((spec.barriers_barrier3_A_) == (spec.specEnum._opening)) || ((spec.barriers_barrier3_A_) == (spec.specEnum._closing))) && (!(!(spec.function_requirements_Barriers_Functional_barrier3_f_sc_())) || (((spec.function_requirements_Barriers_Functional_barrier3_command_stop_()) || ((spec.function_requirements_Barriers_Functional_barrier3_barrier_S_closed_()) && (spec.function_requirements_Barriers_Functional_barrier3_barrier_A_closing_()))) || ((spec.function_requirements_Barriers_Functional_barrier3_barrier_S_open_()) && (spec.function_requirements_Barriers_Functional_barrier3_barrier_A_opening_()))));
     ...
     */
    execEdge158() {
        var guard = (((spec.barriers_barrier4_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier4_f_sc_())) || ((spec.function_requirements_Barriers_Functional_barrier4_command_close_()) && (!(spec.function_requirements_Barriers_Functional_barrier4_barrier_S_closed_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier4_f_sc_())) && (spec.barriers_entering_closed_()));
     ...
     */
    execEdge159() {
        var guard = (((spec.barriers_barrier4_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier4_f_sc_())) || (((((spec.function_requirements_Barriers_Functional_barrier4_command_open_()) || (spec.bridgedeck_command_close_())) && (!(spec.function_requirements_Barriers_Functional_barrier4_command_close_()))) && (!(spec.function_requirements_Barriers_Functional_barrier4_command_stop_()))) && (!(spec.function_requirements_Barriers_Functional_barrier4_barrier_S_open_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier4_f_sc_())) && (spec.bridgedeck_bridgedeck_closed_()));
     ...
     */
    execEdge160() {
        var guard = (((spec.barriers_barrier4_A_) == (spec.specEnum._opening)) || ((spec.barriers_barrier4_A_) == (spec.specEnum._closing))) && (!(!(spec.function_requirements_Barriers_Functional_barrier4_f_sc_())) || (((spec.function_requirements_Barriers_Functional_barrier4_command_stop_()) || ((spec.function_requirements_Barriers_Functional_barrier4_barrier_S_closed_()) && (spec.function_requirements_Barriers_Functional_barrier4_barrier_A_closing_()))) || ((spec.function_requirements_Barriers_Functional_barrier4_barrier_S_open_()) && (spec.function_requirements_Barriers_Functional_barrier4_barrier_A_opening_()))));
     ...
     */
    execEdge161() {
        var guard = ((((spec.barriers_barrier5_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier5_f_sc_())) || ((spec.function_requirements_Barriers_Functional_barrier5_command_close_()) && (!(spec.function_requirements_Barriers_Functional_barrier5_barrier_S_closed_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier5_f_sc_())) && ((!(!(spec.safety_reqirements_Requirement2_Fault1_())) || (spec.LTS_stopsigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault2_())) || (spec.LTS_stopsigns_K_on_()))))) && ((((!(!(spec.safety_reqirements_Requirement2_Fault3_())) || (spec.LTS_stopsigns_SC_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault4_())) || (spec.LTS_stopsigns_SK_on_()))) && (!(spec.safety_reqirements_Requirement2_Fault1_()) || (spec.LTS_stopsigns_C_onF_()))) && (((!(spec.safety_reqirements_Requirement2_Fault2_()) || (spec.LTS_stopsigns_K_onF_())) && (!(spec.safety_reqirements_Requirement2_Fault3_()) || (spec.LTS_stopsigns_SC_onF_()))) && (!(spec.safety_reqirements_Requirement2_Fault4_()) || (spec.LTS_stopsigns_SK_onF_()))));
     ...
     */
    execEdge162() {
        var guard = (((spec.barriers_barrier5_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier5_f_sc_())) || (((((spec.function_requirements_Barriers_Functional_barrier5_command_open_()) || (spec.bridgedeck_command_close_())) && (!(spec.function_requirements_Barriers_Functional_barrier5_command_close_()))) && (!(spec.function_requirements_Barriers_Functional_barrier5_command_stop_()))) && (!(spec.function_requirements_Barriers_Functional_barrier5_barrier_S_open_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier5_f_sc_())) && (spec.bridgedeck_bridgedeck_closed_()));
     ...
     */
    execEdge163() {
        var guard = (((spec.barriers_barrier5_A_) == (spec.specEnum._opening)) || ((spec.barriers_barrier5_A_) == (spec.specEnum._closing))) && (!(!(spec.function_requirements_Barriers_Functional_barrier5_f_sc_())) || (((spec.function_requirements_Barriers_Functional_barrier5_command_stop_()) || ((spec.function_requirements_Barriers_Functional_barrier5_barrier_S_closed_()) && (spec.function_requirements_Barriers_Functional_barrier5_barrier_A_closing_()))) || ((spec.function_requirements_Barriers_Functional_barrier5_barrier_S_open_()) && (spec.function_requirements_Barriers_Functional_barrier5_barrier_A_opening_()))));
     ...
     */
    execEdge164() {
        var guard = ((((spec.barriers_barrier6_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier6_f_sc_())) || ((spec.function_requirements_Barriers_Functional_barrier6_command_close_()) && (!(spec.function_requirements_Barriers_Functional_barrier6_barrier_S_closed_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier6_f_sc_())) && ((!(!(spec.safety_reqirements_Requirement2_Fault1_())) || (spec.LTS_stopsigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault2_())) || (spec.LTS_stopsigns_K_on_()))))) && ((((!(!(spec.safety_reqirements_Requirement2_Fault3_())) || (spec.LTS_stopsigns_SC_on_())) && (!(!(spec.safety_reqirements_Requirement2_Fault4_())) || (spec.LTS_stopsigns_SK_on_()))) && (!(spec.safety_reqirements_Requirement2_Fault1_()) || (spec.LTS_stopsigns_C_onF_()))) && (((!(spec.safety_reqirements_Requirement2_Fault2_()) || (spec.LTS_stopsigns_K_onF_())) && (!(spec.safety_reqirements_Requirement2_Fault3_()) || (spec.LTS_stopsigns_SC_onF_()))) && (!(spec.safety_reqirements_Requirement2_Fault4_()) || (spec.LTS_stopsigns_SK_onF_()))));
     ...
     */
    execEdge165() {
        var guard = (((spec.barriers_barrier6_A_) == (spec.specEnum._rest)) && (!(!(spec.function_requirements_Barriers_Functional_barrier6_f_sc_())) || (((((spec.function_requirements_Barriers_Functional_barrier6_command_open_()) || (spec.bridgedeck_command_close_())) && (!(spec.function_requirements_Barriers_Functional_barrier6_command_close_()))) && (!(spec.function_requirements_Barriers_Functional_barrier6_command_stop_()))) && (!(spec.function_requirements_Barriers_Functional_barrier6_barrier_S_open_()))))) && ((!(spec.function_requirements_Barriers_Functional_barrier6_f_sc_())) && (spec.bridgedeck_bridgedeck_closed_()));
     ...
     */
    execEdge166() {
        var guard = (((spec.barriers_barrier6_A_) == (spec.specEnum._opening)) || ((spec.barriers_barrier6_A_) == (spec.specEnum._closing))) && (!(!(spec.function_requirements_Barriers_Functional_barrier6_f_sc_())) || (((spec.function_requirements_Barriers_Functional_barrier6_command_stop_()) || ((spec.function_requirements_Barriers_Functional_barrier6_barrier_S_closed_()) && (spec.function_requirements_Barriers_Functional_barrier6_barrier_A_closing_()))) || ((spec.function_requirements_Barriers_Functional_barrier6_barrier_S_open_()) && (spec.function_requirements_Barriers_Functional_barrier6_barrier_A_opening_()))));
     ...
     */
    execEdge167() {
        var guard = (((spec.bridgedeck_A_) == (spec.specEnum._stopped)) && ((spec.bridgedeck_command_close_()) && ((spec.bridgedeck_S_) != (spec.specEnum._closed)))) && (spec.shipping_signs_RedOrRedRed_());
     ...
     */
    execEdge168() {
        var guard = (((spec.bridgedeck_A_) == (spec.specEnum._stopped)) && ((spec.bridgedeck_command_open_()) && ((spec.bridgedeck_S_) != (spec.specEnum._up)))) && (((spec.barriers_entering_closed_()) && (spec.barriers_leaving_closed_())) && (spec.barriers_slow_closed_()));
     ...
     */
    execEdge169() {
        var guard = (((spec.bridgedeck_A_) == (spec.specEnum._opening)) || ((spec.bridgedeck_A_) == (spec.specEnum._closing))) && ((spec.bridgedeck_command_stop_()) || ((((spec.bridgedeck_S_) == (spec.specEnum._up)) && ((spec.bridgedeck_A_) == (spec.specEnum._opening))) || (((spec.bridgedeck_S_) == (spec.specEnum._closed)) && ((spec.bridgedeck_A_) == (spec.specEnum._closing)))));
     ...
     */
    execEdge170() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_presigns_presignps1_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_presigns_ps1_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement10_Fault1_())) || (spec.LTS_stopsigns_K_off_())) && ((!(!(spec.safety_reqirements_Requirement10_Fault2_())) || (spec.LTS_stopsigns_C_off_())) && (!(!(spec.safety_reqirements_Requirement10_Fault3_())) || (spec.LTS_stopsigns_slow_off_())))) && (!(spec.safety_reqirements_Requirement10_Fault2_())));
     ...
     */
    execEdge171() {
        var guard = (!(!(spec.function_requirements_LTS_Functional_presigns_presignps1_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_presigns_ps1_A_) == (spec.specEnum._off));
     ...
     */
    execEdge172() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_presigns_presignps2_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_presigns_ps2_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement10_Fault1_())) || (spec.LTS_stopsigns_K_off_())) && ((!(!(spec.safety_reqirements_Requirement10_Fault2_())) || (spec.LTS_stopsigns_C_off_())) && (!(!(spec.safety_reqirements_Requirement10_Fault3_())) || (spec.LTS_stopsigns_slow_off_())))) && (!(spec.safety_reqirements_Requirement10_Fault2_())));
     ...
     */
    execEdge173() {
        var guard = (!(!(spec.function_requirements_LTS_Functional_presigns_presignps2_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_presigns_ps2_A_) == (spec.specEnum._off));
     ...
     */
    execEdge174() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_presigns_presignps3_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_presigns_ps3_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement10_Fault1_())) || (spec.LTS_stopsigns_K_off_())) && ((!(!(spec.safety_reqirements_Requirement10_Fault2_())) || (spec.LTS_stopsigns_C_off_())) && (!(!(spec.safety_reqirements_Requirement10_Fault3_())) || (spec.LTS_stopsigns_slow_off_())))) && (!(spec.safety_reqirements_Requirement10_Fault2_())));
     ...
     */
    execEdge175() {
        var guard = (!(!(spec.function_requirements_LTS_Functional_presigns_presignps3_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_presigns_ps3_A_) == (spec.specEnum._off));
     ...
     */
    execEdge176() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_presigns_presignps4_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_presigns_ps4_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement10_Fault1_())) || (spec.LTS_stopsigns_K_off_())) && ((!(!(spec.safety_reqirements_Requirement10_Fault2_())) || (spec.LTS_stopsigns_C_off_())) && (!(!(spec.safety_reqirements_Requirement10_Fault3_())) || (spec.LTS_stopsigns_slow_off_())))) && (!(spec.safety_reqirements_Requirement10_Fault1_())));
     ...
     */
    execEdge177() {
        var guard = (!(!(spec.function_requirements_LTS_Functional_presigns_presignps4_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_presigns_ps4_A_) == (spec.specEnum._off));
     ...
     */
    execEdge178() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_presigns_presignps5_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_presigns_ps5_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement10_Fault1_())) || (spec.LTS_stopsigns_K_off_())) && ((!(!(spec.safety_reqirements_Requirement10_Fault2_())) || (spec.LTS_stopsigns_C_off_())) && (!(!(spec.safety_reqirements_Requirement10_Fault3_())) || (spec.LTS_stopsigns_slow_off_())))) && (!(spec.safety_reqirements_Requirement10_Fault1_())));
     ...
     */
    execEdge179() {
        var guard = (!(!(spec.function_requirements_LTS_Functional_presigns_presignps5_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_presigns_ps5_A_) == (spec.specEnum._off));
     ...
     */
    execEdge180() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_presigns_presignps6_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_presigns_ps6_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement10_Fault1_())) || (spec.LTS_stopsigns_K_off_())) && ((!(!(spec.safety_reqirements_Requirement10_Fault2_())) || (spec.LTS_stopsigns_C_off_())) && (!(!(spec.safety_reqirements_Requirement10_Fault3_())) || (spec.LTS_stopsigns_slow_off_())))) && (!(spec.safety_reqirements_Requirement10_Fault1_())));
     ...
     */
    execEdge181() {
        var guard = (!(!(spec.function_requirements_LTS_Functional_presigns_presignps6_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_presigns_ps6_A_) == (spec.specEnum._off));
     ...
     */
    execEdge182() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign1_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop1_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault2_())));
     ...
     */
    execEdge183() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign1_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop1_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge184() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign2_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop2_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault2_())));
     ...
     */
    execEdge185() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign2_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop2_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge186() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign3_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop3_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault1_())));
     ...
     */
    execEdge187() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign3_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop3_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge188() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign4_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop4_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault1_())));
     ...
     */
    execEdge189() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign4_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop4_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge190() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign5_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop5_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault3_())));
     ...
     */
    execEdge191() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign5_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop5_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge192() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign6_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop6_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault3_())));
     ...
     */
    execEdge193() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign6_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop6_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge194() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign7_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop7_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault3_())));
     ...
     */
    execEdge195() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign7_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop7_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge196() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign8_f_bridge_())) || ((spec.bridgedeck_command_close_()) && ((spec.LTS_button_on_) != (spec.specEnum._pushed)))) && ((spec.LTS_stopsigns_stop8_A_) == (spec.specEnum._on))) && (((!(!(spec.safety_reqirements_Requirement9_Fault1_())) || (spec.barriers_KtoC_open_())) && ((!(!(spec.safety_reqirements_Requirement9_Fault2_())) || (spec.barriers_CtoK_open_())) && (!(!(spec.safety_reqirements_Requirement9_Fault3_())) || (spec.barriers_slow_open_())))) && (!(spec.safety_reqirements_Requirement9_Fault3_())));
     ...
     */
    execEdge197() {
        var guard = ((!(!(spec.function_requirements_LTS_Functional_stopsigns_stopsign8_f_bridge_())) || ((spec.LTS_button_on_) == (spec.specEnum._pushed))) && ((spec.LTS_stopsigns_stop8_A_) == (spec.specEnum._off))) && ((!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(!(spec.safety_reqirements_Requirement1_Fault1_())) || (spec.LTS_presigns_C_on_())) && (!(!(spec.safety_reqirements_Requirement1_Fault2_())) || (spec.LTS_presigns_K_on_())))) && (!(!(spec.safety_reqirements_Requirement1_Fault3_())) || ((!(spec.safety_reqirements_Requirement1_Fault1_()) || (spec.LTS_presigns_C_onF_())) && (!(spec.safety_reqirements_Requirement1_Fault2_()) || (spec.LTS_presigns_K_onF_())))));
     ...
     */
    execEdge198() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign3_command_gn_()) && ((spec.bridgedeck_bridgedeck_up_()) && ((spec.shipping_signs_downstream_N_A_) == (spec.specEnum._redgreen)));
     ...
     */
    execEdge199() {
        var guard = ((spec.function_requirements_Shipping_sign_Functional_sign3_command_rd_()) || (((spec.bridgedeck_button_stop_) == (spec.specEnum._pushed)) && ((spec.bridgedeck_S_) == (spec.specEnum._between)))) && (((spec.shipping_signs_downstream_N_A_) == (spec.specEnum._redred)) || (((spec.shipping_signs_downstream_N_A_) == (spec.specEnum._redgreen)) || ((spec.shipping_signs_downstream_N_A_) == (spec.specEnum._green))));
     ...
     */
    execEdge200() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign3_command_rg_()) && ((spec.shipping_signs_downstream_N_A_) == (spec.specEnum._red));
     ...
     */
    execEdge201() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign3_command_sp_()) && ((spec.shipping_signs_downstream_N_A_) == (spec.specEnum._red));
     ...
     */
    execEdge202() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign4_command_gn_()) && ((spec.bridgedeck_bridgedeck_up_()) && ((spec.shipping_signs_downstream_S_A_) == (spec.specEnum._redgreen)));
     ...
     */
    execEdge203() {
        var guard = ((spec.function_requirements_Shipping_sign_Functional_sign4_command_rd_()) || (((spec.bridgedeck_button_stop_) == (spec.specEnum._pushed)) && ((spec.bridgedeck_S_) == (spec.specEnum._between)))) && (((spec.shipping_signs_downstream_S_A_) == (spec.specEnum._redred)) || (((spec.shipping_signs_downstream_S_A_) == (spec.specEnum._redgreen)) || ((spec.shipping_signs_downstream_S_A_) == (spec.specEnum._green))));
     ...
     */
    execEdge204() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign4_command_rg_()) && ((spec.shipping_signs_downstream_S_A_) == (spec.specEnum._red));
     ...
     */
    execEdge205() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign4_command_sp_()) && ((spec.shipping_signs_downstream_S_A_) == (spec.specEnum._red));
     ...
     */
    execEdge206() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign1_command_gn_()) && ((spec.bridgedeck_bridgedeck_up_()) && ((spec.shipping_signs_upstream_N_A_) == (spec.specEnum._redgreen)));
     ...
     */
    execEdge207() {
        var guard = ((spec.function_requirements_Shipping_sign_Functional_sign1_command_rd_()) || (((spec.bridgedeck_button_stop_) == (spec.specEnum._pushed)) && ((spec.bridgedeck_S_) == (spec.specEnum._between)))) && (((spec.shipping_signs_upstream_N_A_) == (spec.specEnum._redred)) || (((spec.shipping_signs_upstream_N_A_) == (spec.specEnum._redgreen)) || ((spec.shipping_signs_upstream_N_A_) == (spec.specEnum._green))));
     ...
     */
    execEdge208() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign1_command_rg_()) && ((spec.shipping_signs_upstream_N_A_) == (spec.specEnum._red));
     ...
     */
    execEdge209() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign1_command_sp_()) && ((spec.shipping_signs_upstream_N_A_) == (spec.specEnum._red));
     ...
     */
    execEdge210() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign2_command_gn_()) && ((spec.bridgedeck_bridgedeck_up_()) && ((spec.shipping_signs_upstream_S_A_) == (spec.specEnum._redgreen)));
     ...
     */
    execEdge211() {
        var guard = ((spec.function_requirements_Shipping_sign_Functional_sign2_command_rd_()) || (((spec.bridgedeck_button_stop_) == (spec.specEnum._pushed)) && ((spec.bridgedeck_S_) == (spec.specEnum._between)))) && (((spec.shipping_signs_upstream_S_A_) == (spec.specEnum._redred)) || (((spec.shipping_signs_upstream_S_A_) == (spec.specEnum._redgreen)) || ((spec.shipping_signs_upstream_S_A_) == (spec.specEnum._green))));
     ...
     */
    execEdge212() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign2_command_rg_()) && ((spec.shipping_signs_upstream_S_A_) == (spec.specEnum._red));
     ...
     */
    execEdge213() {
        var guard = (spec.function_requirements_Shipping_sign_Functional_sign2_command_sp_()) && ((spec.shipping_signs_upstream_S_A_) == (spec.specEnum._red));
    ...
    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement1.Fault1".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement1_Fault1_() {
        return ((spec.FTC_D_ps1_f_) || (spec.FTC_D_ps2_f_)) || (spec.FTC_D_ps3_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement1.Fault2".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement1_Fault2_() {
        return ((spec.FTC_D_ps4_f_) || (spec.FTC_D_ps5_f_)) || (spec.FTC_D_ps6_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement1.Fault3".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement1_Fault3_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement2.Fault1".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement2_Fault1_() {
        return (spec.FTC_D_s1_f_) || (spec.FTC_D_s2_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement2.Fault2".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement2_Fault2_() {
        return (spec.FTC_D_s3_f_) || (spec.FTC_D_s4_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement2.Fault3".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement2_Fault3_() {
        return (spec.FTC_D_s5_f_) || (spec.FTC_D_s6_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement2.Fault4".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement2_Fault4_() {
        return (spec.FTC_D_s7_f_) || (spec.FTC_D_s8_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement8.Fault1".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement8_Fault1_() {
        return spec.FTC_D_bar1_f_;
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement8.Fault2".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement8_Fault2_() {
        return spec.FTC_D_bar4_f_;
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement9.Fault1".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement9_Fault1_() {
        return (spec.FTC_D_bar1_f_) || (spec.FTC_D_bar2_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement9.Fault2".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement9_Fault2_() {
        return (spec.FTC_D_bar3_f_) || (spec.FTC_D_bar4_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement9.Fault3".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement9_Fault3_() {
        return (spec.FTC_D_bar5_f_) || (spec.FTC_D_bar6_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement10.Fault1".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement10_Fault1_() {
        return (spec.FTC_D_bar1_f_) || (spec.FTC_D_bar2_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement10.Fault2".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement10_Fault2_() {
        return (spec.FTC_D_bar3_f_) || (spec.FTC_D_bar4_f_);
    }

    /**
     * Evaluates algebraic variable "safety_reqirements.Requirement10.Fault3".
     *
     * @return The evaluation result.
     */
    safety_reqirements_Requirement10_Fault3_() {
        return (spec.FTC_D_bar5_f_) || (spec.FTC_D_bar6_f_);
    }
    ...
    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.command_close".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_command_close_() {
        return spec.barriers_command_close_leaving_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.command_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_command_open_() {
        return spec.barriers_command_open_leaving_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.command_stop".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_command_stop_() {
        return spec.barriers_command_stop_leaving_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.barrier_S_closed".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_barrier_S_closed_() {
        return (spec.barriers_barrier1_S_) == (spec.specEnum._closed);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.barrier_S_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_barrier_S_open_() {
        return (spec.barriers_barrier1_S_) == (spec.specEnum._open);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.barrier_A_closing".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_barrier_A_closing_() {
        return (spec.barriers_barrier1_A_) == (spec.specEnum._closing);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.barrier_A_opening".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_barrier_A_opening_() {
        return (spec.barriers_barrier1_A_) == (spec.specEnum._opening);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier1.f_sc".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier1_f_sc_() {
        return spec.FTC_D_bar1_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.command_close".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_command_close_() {
        return spec.barriers_command_close_entering_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.command_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_command_open_() {
        return spec.barriers_command_open_entering_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.command_stop".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_command_stop_() {
        return spec.barriers_command_stop_entering_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.barrier_S_closed".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_barrier_S_closed_() {
        return (spec.barriers_barrier2_S_) == (spec.specEnum._closed);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.barrier_S_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_barrier_S_open_() {
        return (spec.barriers_barrier2_S_) == (spec.specEnum._open);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.barrier_A_closing".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_barrier_A_closing_() {
        return (spec.barriers_barrier2_A_) == (spec.specEnum._closing);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.barrier_A_opening".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_barrier_A_opening_() {
        return (spec.barriers_barrier2_A_) == (spec.specEnum._opening);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier2.f_sc".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier2_f_sc_() {
        return spec.FTC_D_bar2_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.command_close".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_command_close_() {
        return spec.barriers_command_close_entering_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.command_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_command_open_() {
    ...
    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.command_stop".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_command_stop_() {
        return spec.barriers_command_stop_entering_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.barrier_S_closed".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_barrier_S_closed_() {
        return (spec.barriers_barrier3_S_) == (spec.specEnum._closed);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.barrier_S_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_barrier_S_open_() {
        return (spec.barriers_barrier3_S_) == (spec.specEnum._open);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.barrier_A_closing".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_barrier_A_closing_() {
        return (spec.barriers_barrier3_A_) == (spec.specEnum._closing);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.barrier_A_opening".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_barrier_A_opening_() {
        return (spec.barriers_barrier3_A_) == (spec.specEnum._opening);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier3.f_sc".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier3_f_sc_() {
        return spec.FTC_D_bar3_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.command_close".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_command_close_() {
        return spec.barriers_command_close_leaving_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.command_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_command_open_() {
        return spec.barriers_command_open_leaving_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.command_stop".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_command_stop_() {
        return spec.barriers_command_stop_leaving_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.barrier_S_closed".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_barrier_S_closed_() {
        return (spec.barriers_barrier4_S_) == (spec.specEnum._closed);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.barrier_S_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_barrier_S_open_() {
        return (spec.barriers_barrier4_S_) == (spec.specEnum._open);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.barrier_A_closing".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_barrier_A_closing_() {
        return (spec.barriers_barrier4_A_) == (spec.specEnum._closing);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.barrier_A_opening".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_barrier_A_opening_() {
        return (spec.barriers_barrier4_A_) == (spec.specEnum._opening);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier4.f_sc".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier4_f_sc_() {
        return spec.FTC_D_bar4_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.command_close".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_command_close_() {
        return spec.barriers_command_close_slow_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.command_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_command_open_() {
        return spec.barriers_command_open_slow_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.command_stop".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_command_stop_() {
        return spec.barriers_command_stop_slow_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.barrier_S_closed".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_barrier_S_closed_() {
        return (spec.barriers_barrier5_S_) == (spec.specEnum._closed);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.barrier_S_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_barrier_S_open_() {
        return (spec.barriers_barrier5_S_) == (spec.specEnum._open);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.barrier_A_closing".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_barrier_A_closing_() {
        return (spec.barriers_barrier5_A_) == (spec.specEnum._closing);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.barrier_A_opening".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_barrier_A_opening_() {
        return (spec.barriers_barrier5_A_) == (spec.specEnum._opening);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier5.f_sc".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier5_f_sc_() {
        return spec.FTC_D_bar5_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.command_close".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_command_close_() {
        return spec.barriers_command_close_slow_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.command_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_command_open_() {
        return spec.barriers_command_open_slow_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.command_stop".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_command_stop_() {
        return spec.barriers_command_stop_slow_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.barrier_S_closed".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_barrier_S_closed_() {
        return (spec.barriers_barrier6_S_) == (spec.specEnum._closed);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.barrier_S_open".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_barrier_S_open_() {
        return (spec.barriers_barrier6_S_) == (spec.specEnum._open);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.barrier_A_closing".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_barrier_A_closing_() {
        return (spec.barriers_barrier6_A_) == (spec.specEnum._closing);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.barrier_A_opening".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_barrier_A_opening_() {
        return (spec.barriers_barrier6_A_) == (spec.specEnum._opening);
    }

    /**
     * Evaluates algebraic variable "function_requirements.Barriers_Functional.barrier6.f_sc".
     *
     * @return The evaluation result.
     */
    function_requirements_Barriers_Functional_barrier6_f_sc_() {
        return spec.FTC_D_bar6_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign1.command_rd".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign1_command_rd_() {
        return spec.shipping_signs_upstream_command_rd_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign1.command_gn".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign1_command_gn_() {
        return spec.shipping_signs_upstream_command_gn_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign1.command_rg".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign1_command_rg_() {
        return spec.shipping_signs_upstream_command_rg_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign1.command_sp".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign1_command_sp_() {
        return spec.shipping_signs_upstream_command_sp_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign2.command_rd".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign2_command_rd_() {
        return spec.shipping_signs_upstream_command_rd_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign2.command_gn".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign2_command_gn_() {
        return spec.shipping_signs_upstream_command_gn_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign2.command_rg".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign2_command_rg_() {
        return spec.shipping_signs_upstream_command_rg_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign2.command_sp".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign2_command_sp_() {
        return spec.shipping_signs_upstream_command_sp_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign3.command_rd".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign3_command_rd_() {
        return spec.shipping_signs_downstream_command_rd_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign3.command_gn".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign3_command_gn_() {
        return spec.shipping_signs_downstream_command_gn_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign3.command_rg".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign3_command_rg_() {
        return spec.shipping_signs_downstream_command_rg_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign3.command_sp".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign3_command_sp_() {
        return spec.shipping_signs_downstream_command_sp_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign4.command_rd".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign4_command_rd_() {
        return spec.shipping_signs_downstream_command_rd_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign4.command_gn".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign4_command_gn_() {
        return spec.shipping_signs_downstream_command_gn_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign4.command_rg".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign4_command_rg_() {
        return spec.shipping_signs_downstream_command_rg_();
    }

    /**
     * Evaluates algebraic variable "function_requirements.Shipping_sign_Functional.sign4.command_sp".
     *
     * @return The evaluation result.
     */
    function_requirements_Shipping_sign_Functional_sign4_command_sp_() {
        return spec.shipping_signs_downstream_command_sp_();
    }
    ...
    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign1.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign1_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign2.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign2_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign3.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign3_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign4.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign4_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign5.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign5_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign6.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign6_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign7.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign7_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.stopsigns.stopsign8.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_stopsigns_stopsign8_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.presigns.presignps1.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_presigns_presignps1_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.presigns.presignps2.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_presigns_presignps2_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.presigns.presignps3.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_presigns_presignps3_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.presigns.presignps4.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_presigns_presignps4_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.presigns.presignps5.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_presigns_presignps5_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }

    /**
     * Evaluates algebraic variable "function_requirements.LTS_Functional.presigns.presignps6.f_bridge".
     *
     * @return The evaluation result.
     */
    function_requirements_LTS_Functional_presigns_presignps6_f_bridge_() {
        return spec.FTC_D_bridge_f_;
    }
