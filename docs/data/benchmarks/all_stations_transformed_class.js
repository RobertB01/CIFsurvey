...
class spec_class {
     ...
     */
    execEdge182() {
        var guard = ((spec.S_product_) == (spec.specEnum._On)) && ((spec.STimer_) == (spec.specEnum._Off));
     ...
     */
    execEdge183() {
        var guard = ((spec.S_slidefull_) == (spec.specEnum._On)) && (((spec.STimer_) == (spec.specEnum._Running)) || ((spec.STimer_) == (spec.specEnum._Timeout)));
