...
class spec_class {
     ...
     */
    execEdge41() {
        var guard = (((spec.MM_) == (spec.specEnum._Active)) || ((spec.MM_) == (spec.specEnum._Reset))) && ((spec.RL_) == (spec.specEnum._On));
     ...
     */
    execEdge42() {
        var guard = ((spec.MM_) == (spec.specEnum._Emergency)) && ((spec.RL_) == (spec.specEnum._Off));
     ...
     */
    execEdge43() {
        var guard = (((spec.MM_) == (spec.specEnum._Reset)) || ((spec.MM_) == (spec.specEnum._Emergency))) && ((spec.SH_) == (spec.specEnum._On));
     ...
     */
    execEdge44() {
        var guard = ((spec.MM_) == (spec.specEnum._Active)) && (((spec.SM_) == (spec.specEnum._On)) && (((spec.DM_) == (spec.specEnum._On)) && ((spec.SH_) == (spec.specEnum._Off))));
     ...
     */
    execEdge45() {
        var guard = (((spec.MM_) == (spec.specEnum._Reset)) || ((spec.MM_) == (spec.specEnum._Emergency))) && (((spec.DM_) == (spec.specEnum._Off)) && ((spec.SM_) == (spec.specEnum._On)));
     ...
     */
    execEdge46() {
        var guard = ((spec.MM_) == (spec.specEnum._Active)) && ((spec.SM_) == (spec.specEnum._Off));
