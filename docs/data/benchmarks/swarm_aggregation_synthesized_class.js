...
class spec_class {
    ...
    /** Discrete variable "NoRobotPerceived". */
    NoRobotPerceived_;

    /** Discrete variable "RobotPerceived". */
    RobotPerceived_;
     ...
     */
    execEdge0() {
        var guard = (((spec.NoRobotPerceived_) == (spec.specEnum._q1)) || ((spec.NoRobotPerceived_) == (spec.specEnum._q2))) && (((spec.RobotPerceived_) == (spec.specEnum._q1)) || ((spec.RobotPerceived_) == (spec.specEnum._q2)));
        ...
        if ((spec.NoRobotPerceived_) == (spec.specEnum._q1)) {
            spec.NoRobotPerceived_ = spec.specEnum._q2;
        } else if ((spec.NoRobotPerceived_) == (spec.specEnum._q2)) {
            spec.NoRobotPerceived_ = spec.specEnum._q2;
        }
        if ((spec.RobotPerceived_) == (spec.specEnum._q1)) {
            spec.RobotPerceived_ = spec.specEnum._q1;
        } else if ((spec.RobotPerceived_) == (spec.specEnum._q2)) {
            spec.RobotPerceived_ = spec.specEnum._q1;
        }
    ...
    execEdge1() {
        ...
        if ((spec.NoRobotPerceived_) == (spec.specEnum._q1)) {
            spec.NoRobotPerceived_ = spec.specEnum._q1;
        } else if ((spec.NoRobotPerceived_) == (spec.specEnum._q2)) {
            spec.NoRobotPerceived_ = spec.specEnum._q1;
        }
        if ((spec.RobotPerceived_) == (spec.specEnum._q1)) {
            spec.RobotPerceived_ = spec.specEnum._q2;
        } else if ((spec.RobotPerceived_) == (spec.specEnum._q2)) {
            spec.RobotPerceived_ = spec.specEnum._q2;
        }
    ...
    /**
     * Execute code for edge with index 2 and event "V0".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge2() {
        var guard = (((spec.AlternateV0_) == (spec.specEnum._q1)) && (((spec.AlternateV1_) == (spec.specEnum._q1)) || ((spec.AlternateV1_) == (spec.specEnum._q2)))) && ((spec.NoRobotPerceived_) == (spec.specEnum._q2));
    ...
    /**
     * Execute code for edge with index 3 and event "V1".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge3() {
        var guard = ((((spec.AlternateV0_) == (spec.specEnum._q1)) || ((spec.AlternateV0_) == (spec.specEnum._q2))) && ((spec.AlternateV1_) == (spec.specEnum._q1))) && ((spec.RobotPerceived_) == (spec.specEnum._q2));
    ...
    getStateText() {
        ...
        state += specUtils.fmt(', NoRobotPerceived=%s', specUtils.valueToStr(spec.NoRobotPerceived_));
        state += specUtils.fmt(', RobotPerceived=%s', specUtils.valueToStr(spec.RobotPerceived_));
        return state;
    }
