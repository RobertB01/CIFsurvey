...
class spec_class {
     ...
     */
    execEdge4() {
        var guard = (((spec.OP1_) == (spec.specEnum._Busy)) && ((spec.CHK_) == (spec.specEnum._Idle))) && ((((spec.DISP_) == (spec.specEnum._Idle)) || (specUtils.equalObjs(spec.DISP_curId_, ((spec.OP1_curId_) + (1)) % (spec.MAX_NR_OF_PRODS_)))) && (((spec.OP2_) == (spec.specEnum._Idle)) || (specUtils.equalObjs(spec.OP2_curId_, ((spec.OP1_curId_) + (1)) % (spec.MAX_NR_OF_PRODS_)))));
     ...
     */
    execEdge5() {
        var guard = (((spec.OP2_) == (spec.specEnum._Busy)) && ((spec.CHK_) == (spec.specEnum._Idle))) && ((((spec.DISP_) == (spec.specEnum._Idle)) || (specUtils.equalObjs(spec.DISP_curId_, ((spec.OP2_curId_) + (1)) % (spec.MAX_NR_OF_PRODS_)))) && (((spec.OP1_) == (spec.specEnum._Idle)) || (specUtils.equalObjs(spec.OP1_curId_, ((spec.OP2_curId_) + (1)) % (spec.MAX_NR_OF_PRODS_)))));
     ...
     */
    execEdge6() {
        var guard = (((spec.INOUT_) == (spec.specEnum._Idle)) && ((spec.INOUT_cnt_) < (spec.MAX_NR_OF_PRODS_))) && ((spec.INOUT_cnt_) < (4));
     ...
     */
    execEdge11() {
        var guard = (((spec.INOUT_) == (spec.specEnum._NewProduct)) && ((spec.DISP_) == (spec.specEnum._Idle))) && (((spec.sup_nrOfProdsInLoop_()) < (2)) || ((specUtils.equalObjs(spec.sup_nrOfProdsInLoop_(), 2)) && ((spec.CHK_) == (spec.specEnum._Success))));
    ...
    /**
     * Evaluates algebraic variable "sup.nrOfProdsInLoop".
     *
     * @return The evaluation result.
     */
    sup_nrOfProdsInLoop_() {
        return (((((spec.DISP_) == (spec.specEnum._Idle)) ? 0 : (1)) + (((spec.OP1_) == (spec.specEnum._Idle)) ? 0 : (1))) + (((spec.OP2_) == (spec.specEnum._Idle)) ? 0 : (1))) + (((spec.CHK_) == (spec.specEnum._Idle)) ? 0 : (1));
    }
