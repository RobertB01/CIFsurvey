...
class spec_class {
    ...
    specEnum = Object.freeze({
        /** Literal "closedDoors". */
        _closedDoors: Symbol("closedDoors"),
    ...
    /** Discrete variable "washingMachine.coins". */
    washingMachine_coins_;

    /** Discrete variable "washingMachine". */
    washingMachine_;
    ...
    execOnce(newTime) {
        ...
        while (true) {
            ...
            // Event "washingMachine.closeDoor".
            edgeExecuted |= this.execEdge0();

            // Event "washingMachine.insertCoin".
            edgeExecuted |= this.execEdge1();

            // Event "washingMachine.openDoor".
            edgeExecuted |= this.execEdge2();

            // Event "washingMachine.returnCoin".
            edgeExecuted |= this.execEdge3();

            // Event "washingMachine.select40".
            edgeExecuted |= this.execEdge4();

            // Event "washingMachine.select90".
    ...
    /**
     * Execute code for edge with index 0 and event "washingMachine.closeDoor".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge0() {
        var guard = (spec.washingMachine_) == (spec.specEnum._ready);
        ...
        spec.washingMachine_ = spec.specEnum._closedDoors;
    ...
    /**
     * Execute code for edge with index 1 and event "washingMachine.insertCoin".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge1() {
        var guard = ((spec.washingMachine_) == (spec.specEnum._ready)) || ((spec.washingMachine_) == (spec.specEnum._closedDoors));
        ...
        if ((spec.washingMachine_) == (spec.specEnum._ready)) {
            spec.washingMachine_coins_ = specUtils.addInt(spec.washingMachine_coins_, 1);
        } else if ((spec.washingMachine_) == (spec.specEnum._closedDoors)) {
            spec.washingMachine_coins_ = specUtils.addInt(spec.washingMachine_coins_, 1);
        }
    ...
    /**
     * Execute code for edge with index 2 and event "washingMachine.openDoor".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge2() {
        var guard = ((spec.washingMachine_) == (spec.specEnum._closedDoors)) || (((spec.washingMachine_) == (spec.specEnum._washAt90)) || ((spec.washingMachine_) == (spec.specEnum._washAt40)));
        ...
        if ((spec.washingMachine_) == (spec.specEnum._closedDoors)) {
            spec.washingMachine_ = spec.specEnum._ready;
        } else if ((spec.washingMachine_) == (spec.specEnum._washAt90)) {
            spec.washingMachine_ = spec.specEnum._ready;
        } else if ((spec.washingMachine_) == (spec.specEnum._washAt40)) {
            spec.washingMachine_ = spec.specEnum._ready;
        }
    ...
    /**
     * Execute code for edge with index 3 and event "washingMachine.returnCoin".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge3() {
        var guard = (((spec.washingMachine_) == (spec.specEnum._ready)) && ((spec.washingMachine_coins_) >= (1))) || (((spec.washingMachine_) == (spec.specEnum._closedDoors)) && ((spec.washingMachine_coins_) >= (1)));
        ...
        if (((spec.washingMachine_) == (spec.specEnum._ready)) && ((spec.washingMachine_coins_) >= (1))) {
            spec.washingMachine_coins_ = specUtils.subtractInt(spec.washingMachine_coins_, 1);
        } else if (((spec.washingMachine_) == (spec.specEnum._closedDoors)) && ((spec.washingMachine_coins_) >= (1))) {
            spec.washingMachine_coins_ = specUtils.subtractInt(spec.washingMachine_coins_, 1);
        }
    ...
    /**
     * Execute code for edge with index 4 and event "washingMachine.select40".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge4() {
        var guard = ((spec.washingMachine_) == (spec.specEnum._closedDoors)) && (specUtils.equalObjs(spec.washingMachine_coins_, 1));
        ...
        spec.washingMachine_coins_ = 0;
        spec.washingMachine_ = spec.specEnum._washAt40;
    ...
    /**
     * Execute code for edge with index 5 and event "washingMachine.select90".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge5() {
        var guard = ((spec.washingMachine_) == (spec.specEnum._closedDoors)) && (specUtils.equalObjs(spec.washingMachine_coins_, 2));
        ...
        spec.washingMachine_coins_ = 0;
        spec.washingMachine_ = spec.specEnum._washAt90;
    ...
    getStateText() {
        ...
        state += specUtils.fmt(', washingMachine=%s', specUtils.valueToStr(spec.washingMachine_));
        state += specUtils.fmt(', washingMachine.coins=%s', specUtils.valueToStr(spec.washingMachine_coins_));
        return state;
    }
