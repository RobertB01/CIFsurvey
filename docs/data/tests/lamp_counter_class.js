...
class spec_class {
    ...
    /**
     * Execute code for edge with index 0 and event "turn_off".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge0() {
        var guard = (spec.lamp_) == (spec.specEnum._On);
    ...
    /**
     * Execute code for edge with index 1 and event "turn_on".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge1() {
        var guard = (spec.lamp_) == (spec.specEnum._Off);
        ...
        spec.lamp_count_ = specUtils.addInt(spec.lamp_count_, 1);
    ...
    getStateText() {
        ...
        state += specUtils.fmt(', lamp.count=%s', specUtils.valueToStr(spec.lamp_count_));
        return state;
    }
