...
class spec_class {
    ...
    specEnum = Object.freeze({
        /** Literal "consuming". */
        _consuming: Symbol("consuming"),

        /** Literal "idle". */
        _idle: Symbol("idle"),

        /** Literal "producing". */
        _producing: Symbol("producing")
    })
    ...
    /** Discrete variable "consumer". */
    consumer_;

    /** Discrete variable "producer". */
    producer_;
    ...
    /**
     * Execute code for edge with index 0 and event "consumer.consume".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge0() {
        var guard = (spec.consumer_) == (spec.specEnum._consuming);
        ...
        spec.consumer_ = spec.specEnum._idle;
    ...
    /**
     * Execute code for edge with index 1 and event "producer.produce".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge1() {
        var guard = (spec.producer_) == (spec.specEnum._producing);
        ...
        spec.producer_ = spec.specEnum._idle;
    ...
    /**
     * Execute code for edge with index 2 and event "producer.provide".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge2() {
        var guard = ((spec.consumer_) == (spec.specEnum._idle)) && ((spec.producer_) == (spec.specEnum._idle));
        ...
        spec.consumer_ = spec.specEnum._consuming;
        spec.producer_ = spec.specEnum._producing;
    ...
    getStateText() {
        ...
        state += specUtils.fmt(', consumer=%s', specUtils.valueToStr(spec.consumer_));
        state += specUtils.fmt(', producer=%s', specUtils.valueToStr(spec.producer_));
        return state;
    }
