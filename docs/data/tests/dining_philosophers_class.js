...
class spec_class {
     ...
     */
    execEdge0() {
        var guard = ((spec.fork1_) == (spec.specEnum._P1)) && (((spec.fork2_) == (spec.specEnum._P1)) && ((spec.philosopher1_) == (spec.specEnum._E)));
     ...
     */
    execEdge1() {
        var guard = ((spec.fork1_) == (spec.specEnum._I)) && (((spec.philosopher1_) == (spec.specEnum._T)) || ((spec.philosopher1_) == (spec.specEnum._F2)));
        ...
        } else if ((spec.philosopher1_) == (spec.specEnum._F2)) {
    ...
    /**
     * Execute code for edge with index 2 and event "p1f2".
     *
     * @return 'true' if the edge was executed, 'false' otherwise.
     */
    execEdge2() {
        var guard = ((spec.fork2_) == (spec.specEnum._I)) && (((spec.philosopher1_) == (spec.specEnum._T)) || ((spec.philosopher1_) == (spec.specEnum._F1)));
        ...
        spec.fork2_ = spec.specEnum._P1;
        if ((spec.philosopher1_) == (spec.specEnum._T)) {
            spec.philosopher1_ = spec.specEnum._F2;
